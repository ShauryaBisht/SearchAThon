...
userRouter.post('/avatar/upload',upload.single("image"),verifyJWT,uploadLimiter,uploadProfilePic)
userRouter.delete('/avatar/delete',verifyJWT,actionLimiter,deleteProfilePic)
userRouter.post('/team/avatar/upload',upload.single("image"),verifyJWT,uploadLimiter,uploadTeamPic)
